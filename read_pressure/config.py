...
Config = SimpleNamespace(
    ...
    shaft_displacement=(3.5, 0.0),  # the displacement in pixels of the recognized scale center from the shaft center
    ...
    # Debugging
    text_pos=(0.5, 0.8),  # relatively to the image size
...
MarkSimilRange = Ranges((0.86, 0.99), (0.91, 0.97),   (0.73, 0.79))
MarkRatioRange = Ranges((0.09, 0.15), (0.072, 0.095), (0.22, 0.24))
